...
#### HBX交易所开发文档([English Docs](https://github.com/hbx-im/hbx-api/blob/master/api/us_en/api_doc_en.md))
- [介绍](#Introduction)
- [开始使用](#startToUse)
- [API接口加密验证](#a1)
    - [生成API Key](#a2)
...
REST访问的根URL：``` https://openapi.hbx.im ```
...
/** 4个变量，api_key,secret_key */ 
 ...
 String secret_key = "1c16******************2982";
        ...
        /** http请求 */
        String resultJson = get("https://openapi.hbx.im/open/api/get_trades?symbol=btcusdt", params);
...
public class WsTest {
    ...
    public static void main(String[] args) {
        try {
//wsurl 
            String url = "wss://ws.hbx.im/kline-api/ws";
//历史数据请求参数 
